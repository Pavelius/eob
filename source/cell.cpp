...
BSDATA(celli) = {
	...
	{"Web", DECORS, 0 * decor_frames, {LookObject}, CellWebTorned},
	{"Web (torned)", DECORS, 1 * decor_frames, {LookObject, Passable}},
	{"Barel", DECORS, 3 * decor_frames, {LookObject}, CellBarelDestroyed},
	{"Destroyed Barel", DECORS, 4 * decor_frames, {LookObject, Passable}},
	{"Eyed column", DECORS, 5 * decor_frames, {LookObject}},
	{"Cocon", DECORS, 6 * decor_frames, {LookObject}, CellCoconOpened},
	{"Opened cocon", DECORS, 7 * decor_frames, {LookObject, Passable}},
	{"Grave", DECORS, 8 * decor_frames, {LookObject, Passable}, CellGraveDesecrated},
	{"Grave desecrated", DECORS, 9 * decor_frames, {LookObject, Passable}},
