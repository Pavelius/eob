...
static enchantmenti magic_swords[] = {
	...
	{Rare, "defence+1", {AC, 1}},
	{Rare, 0, {{}, 3}},
	{Rare, "speed+3", {OfSpeed, 3}},
	{Rare, "fear+2", {MageFear, 2}},
	{Rare, "luck+2", {AC, 2}},
	{Rare, "fire+2", {OfFire, 2}},
	{Rare, "frost+2", {OfCold, 2}},
...
BSDATA(itemi) = {
	...
	{"Warhammer", Rare, {99, 13, 1}, 2 * GP, 0, Weapons, RightHand, {}, {UseInHand}, {2, Bludgeon, -4, {1, 4, 1}, {1, 4}}, {}, magic_bludgeon},
