...
const char* szprintv(char* result, const char* result_maximum, const char* src, const char* vl) {
	stringcreator e(result, result_maximum);
	e.addv(src, vl);
	return e;
}

void stringcreator::skip() {
	while(*p && p < pe)
		p++;
}

const char* szprint(char* result, const char* result_maximum, const char* src, ...) {
	stringcreator e(result, result_maximum);
