...
{"Arena", {}},
{"Armory", {BUILDNGS, 8}, "This place is full of weapon for sale. You can buy new weapon or sell.", {Buy, Sell}, {Armors, Weapons}},
{"Bank"},
{"Brothel"},
{"Library", {}, ""},
{"Harbor", {BUILDNGS, 10}, "In harbor present many ships at now. You can travel from here to any settlement where harbor present.", {Travel}},
{"Prison"},
{"Stable", {BUILDNGS, 14}, "Stable has caravans, that leave city in any directions. You can reach at distant location for some gold coins.", {Travel}},
{"Stock"},
